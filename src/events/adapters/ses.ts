...
import { extractCorrelationFromSesMail } from "../correlator.js";
  ...
  return {
    ...
    toStandardEvent(stripped: Record<string, unknown>, c: Correlation): StandardizedEvent | null {
      ...
      if (eventType === "Bounce") {
        ...
        if (bounce && typeof bounce.timestamp === "string") {
          /* bounce reason from diagnostic in first recipient — stripped */
        }
      }
      if (eventType === "Click") {
